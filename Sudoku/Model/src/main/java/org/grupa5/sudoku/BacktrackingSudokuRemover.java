...
//    private List<List<SudokuField>> copyBoard;
    ...
    public BacktrackingSudokuRemover(SudokuBoard board, int numOfFieldsToRemove) throws CloneNotSupportedException {
        this.sudokuBoard = board;
        this.numOfFieldsToRemove = numOfFieldsToRemove;
        this.copyBoard =  this.sudokuBoard.clone();
        for (List<SudokuField> var : this.copyBoard.getBoard()) {
...
//        board.set(8,8,5);
        ...
        SudokuRemover remover = new BacktrackingSudokuRemover(board, 20);
        System.out.println(board);
    }
}
